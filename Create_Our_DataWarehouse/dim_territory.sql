...
IF EXISTS (SELECT * FROM   sys.foreign_keys WHERE  NAME = 'fk_fact_sales_dim_territory'
...
-- create indexes
IF EXISTS (SELECT * FROM   sys.indexes WHERE  NAME = 'dim_territory_territory_code'
