...
-- Create Indexes
IF EXISTS (SELECT * FROM   sys.indexes WHERE  NAME = 'fact_sales_dim_product'
...
IF EXISTS (SELECT * FROM   sys.indexes WHERE  NAME = 'fact_sales_dim_customer'
                  AND object_id = Object_id('fact_sales'))
...
IF EXISTS (SELECT * FROM   sys.indexes WHERE  NAME = 'fact_sales_dim_territory'
                  AND object_id = Object_id('fact_sales'))
...
IF EXISTS (SELECT * FROM   sys.indexes WHERE  NAME = 'fact_sales_dim_date'
                  AND object_id = Object_id('fact_sales'))
